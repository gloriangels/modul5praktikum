...
<body>
    <nav class="navbar navbar-expand-md navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand mb-0 h1" href="{{ route('home') }}"><i
        ...
        <hr class="d-lg-none text-white-50">
        <a class="btn btn-outline-light my-2 ms-md-auto" href="{{route('profile') }}">
    ...
    <div class="col-md-6 mb-3">
        ...
        $employee->id == $position->id ? 'selected' : '' }} > {{ $position->code.' - '.$position->name }}></option>
        @endforeach
        </select>
    </div>
    <hr>
